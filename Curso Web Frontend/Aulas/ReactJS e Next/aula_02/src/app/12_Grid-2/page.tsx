...
const Page = () => {
  return (
    <div>
      ...
      <br />
      <div className="border-2 p-3 m-2 gap-2 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        ...
        <div className="caixa">Caixa 10</div>
        <div className="caixa">Caixa 11</div>
        <div className="caixa">Caixa 12</div>
      </div>
    </div>
  );
};
